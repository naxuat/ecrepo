...
%%% sa2ajj: the module name is changed so it would not conflict with other
%%% instances of the module.  Other than that, no changes to the module.
-module(ecrepo_getopt).
